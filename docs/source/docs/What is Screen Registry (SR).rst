...
- The Screen Registry defines these forms — what fields appear, their type (text, dropdown, date), and validations.  
...
2. **Jackie** adds fields that match **Andy’s Data Dictionary**.  
